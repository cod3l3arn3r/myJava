/**
  * The program simulates the rolling of dice
**/

public class DieDemo {
	public static void main(String[] args) {

		final int DIE1_SIDES = 6;  // Number of sides die # 1
		final int DIE2_SIDES = 12; // Number of sides die # 2
