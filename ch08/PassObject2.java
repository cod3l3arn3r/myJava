...
public class PassObject2 {
	public static void main(String[] args) {
		...
		System.out.println("Contents of the boxe's object: ");
		...
		// Display the object's content again
		System.out.println("Length: " + box.getLength() +
				", Width: " + box.getWidth());
	}

	/**
	  * The changeRectangle method sets a Rectangle object's
	  * length and width to 0
