...
/**
  * This program demostrates how a method can return
...
public class ReturnObject {
	public static void main(String[] args) {
		...
		// Display the accounts balance
		JOptionPane.showMessageDialog(null,
				String.format("The account has a balance of $" +
					account.getBalance()));
	...
	**/
	public static BankAccount getAccount() {
		...
		// Create a BankAccount object and reference to it
